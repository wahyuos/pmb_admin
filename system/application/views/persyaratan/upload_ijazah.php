                ...
                <div class="list-group mb-3 mt-2 rounded-lg">
                    <?php if ($doc_ijazah) : ?>
                        <div class="list-group-item text-center p-3">
                            <h6 id="title" class="mb-2">Ijazah telah diupload</h6>
                            Pastikan tulisan pada dokumen terlihat jelas dan mudah dibaca
                        </div>
                        <div class="list-group-item text-center p-3">
                            <img id="preview" class="rounded-md" src="data:<?= $doc_ijazah->type_doc ?>;base64,<?= $doc_ijazah->blob_doc ?>" width="100%" height="auto">
                        </div>
                    <?php else : ?>
                        <div class="list-group-item text-center p-3">
...
<script type="text/javascript">
    ...
    const myForm = document.getElementById('f_doc_ijazah');
